          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl p-12 max-w-md mx-auto px-8">
            ...
            <div className="space-y-2 text-sm text-white/90">
              ...
              <p className={progress > 30 ? 'text-white' : 'text-white/60'}>
                {progress > 30 ? '✅' : '⏳'} Analyzing visual behavior (facial expressions, posture, eye contact)
              </p>
              <p className={progress > 60 ? 'text-white' : 'text-white/60'}>
                {progress > 60 ? '✅' : '⏳'} Analyzing communication (filler words, pace, vocabulary)
              </p>
              <p className={progress > 90 ? 'text-white' : 'text-white/60'}>
                {progress > 90 ? '✅' : '⏳'} Generating AI-powered insights
              </p>
            </div>
          </div>
        </div>
    ...
    <div className="min-h-screen relative overflow-hidden" style={{
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          {/* Overall Score Card */}
        {overall_score && (
          <div className="bg-gradient-to-r from-blue-600/90 to-purple-600/90 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl p-8 mb-8 text-white">
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                <h2 className="text-2xl font-bold mb-2">Overall Performance</h2>
                <p className="text-blue-100">Combined CV and Communication Analysis</p>
              </div>
              <div className="text-center">
                <div className="text-6xl font-bold mb-2">{overall_score.overall_score}</div>
                <div className="text-2xl font-semibold bg-white/20 rounded-full px-6 py-2">
            ...
            <div className="grid md:grid-cols-2 gap-4 mt-6">
              <div className="bg-white/10 backdrop-blur rounded-xl p-4">
                <div className="text-sm text-blue-100 mb-1">Visual Behavior Score</div>
                <div className="text-3xl font-bold">{overall_score.cv_score}/100</div>
              </div>
              <div className="bg-white/10 backdrop-blur rounded-xl p-4">
                <div className="text-sm text-blue-100 mb-1">Communication Score</div>
                <div className="text-3xl font-bold">{overall_score.communication_score}/100</div>
              </div>
            </div>
          </div>
        )}
          ...
          {cv_analysis && (
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl p-6">
              ...
              {cv_analysis.emotions && (
                <div className="mb-6">
                  <h4 className="text-lg font-semibold text-white mb-3">🎭 Emotional State</h4>
              ...
              {cv_analysis.eye_contact && (
                <div className="mb-6">
                  <h4 className="text-lg font-semibold text-white mb-3">👀 Eye Contact</h4>
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
              ...
              {cv_analysis.posture && (
                <div className="mb-6">
                  <h4 className="text-lg font-semibold text-white mb-3">🧘 Posture</h4>
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
          ...
          {transcript_analysis && (
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl p-6">
              ...
              {transcript_analysis.filler_word_analysis && (
                <div className="mb-6">
                  <h4 className="text-lg font-semibold text-white mb-3">Filler Words</h4>
                  <div className="space-y-3">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-yellow-50 rounded-lg p-3">
                        <div className="text-xs text-yellow-700 mb-1">Total Filler Words</div>
                        <div className="text-2xl font-bold text-yellow-900">
                          {transcript_analysis.filler_word_analysis.total_filler_words}
                        </div>
                      </div>
                      <div className="bg-yellow-50 rounded-lg p-3">
                        <div className="text-xs text-yellow-700 mb-1">Filler Percentage</div>
                        <div className="text-2xl font-bold text-yellow-900">
                    ...
                    <div className="text-sm">
                      <span className="text-white/70">Most used:</span>
                    ...
                    <div className={`text-sm px-3 py-2 rounded-lg ${
                      transcript_analysis.filler_word_analysis.rating === 'excellent' ? 'bg-green-50 text-green-700' :
                      transcript_analysis.filler_word_analysis.rating === 'good' ? 'bg-blue-50 text-blue-700' :
                      transcript_analysis.filler_word_analysis.rating === 'fair' ? 'bg-yellow-50 text-yellow-700' :
              ...
              {transcript_analysis.speaking_pace && (
                <div className="mb-6">
                  <h4 className="text-lg font-semibold text-white mb-3">⏱️ Speaking Pace</h4>
                  <div className="space-y-2">
                    <div className="bg-blue-50 rounded-lg p-3">
                      <div className="text-xs text-blue-700 mb-1">Words Per Minute</div>
              ...
              {transcript_analysis.word_diversity && (
                <div className="mb-6">
                  <h4 className="text-lg font-semibold text-white mb-3">📚 Vocabulary</h4>
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
              ...
              {transcript_analysis.communication_score && (
                <div className="bg-gradient-to-r from-green-500/20 to-blue-500/20 backdrop-blur-sm border border-white/10 rounded-xl p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-sm text-white/70 mb-1">Communication Score</div>
        ...
        {transcript_analysis && transcript_analysis.full_transcript && (
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl p-8 mb-8">
            <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
              📝 Full Transcript
            </h3>
            <div className="bg-black/20 backdrop-blur-sm rounded-xl p-6 max-h-96 overflow-y-auto">
        ...
        <div className="flex justify-center gap-4">
          <button
            onClick={() => navigate('/profile')}
            className="px-8 py-3 bg-white/10 backdrop-blur-md border border-white/20 text-white rounded-xl hover:bg-white/20 transition-all font-semibold shadow-lg"
          >
            Back to Profile
          </button>
          <button
            onClick={() => window.print()}
            className="px-8 py-3 bg-blue-400/80 backdrop-blur-md border border-blue-400/30 text-white rounded-xl hover:bg-blue-400 transition-all font-semibold shadow-lg"
          >
            📄 Download Report (PDF)
          </button>
        </div>
